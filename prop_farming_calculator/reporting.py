...
def write_reports(
    ...
    *,
    ...
    summary_keys = [
        ...
        "audition_pass_pct",
        "audition_pass_pct_ci95_low",
        "audition_pass_pct_ci95_high",
        ...
        "avg_net_profit_per_trader_ci95_low",
        "avg_net_profit_per_trader_ci95_high",
        "avg_roi_pct",
        "avg_roi_pct_ci95_low",
        "avg_roi_pct_ci95_high",
        "pct_positive_roi",
        "pct_positive_roi_ci95_low",
        "pct_positive_roi_ci95_high",
        "eval_starts_scaled",
        "farm_est_total_fees",
        "farm_est_net",
        "mean_days_to_pass_eval_conditional_mc",
        "mean_days_to_pass_eval_conditional_mc_ci95_low",
        "mean_days_to_pass_eval_conditional_mc_ci95_high",
        "mean_days_to_first_payout_trading",
        "mean_days_to_first_payout_trading_ci95_low",
        "mean_days_to_first_payout_trading_ci95_high",
    ...
    for block in horizon_results:
        ...
        lines.extend(
            [
                ...
                f"| Audition pass 95% interval | {_fmt_pct(float(block.get('audition_pass_pct_ci95_low', float('nan'))))} to {_fmt_pct(float(block.get('audition_pass_pct_ci95_high', float('nan'))))} |",
                ...
                f"| Days to pass 95% interval | {_fmt_days(float(block.get('mean_days_to_pass_eval_conditional_mc_ci95_low', float('nan'))))} to {_fmt_days(float(block.get('mean_days_to_pass_eval_conditional_mc_ci95_high', float('nan'))))} |",
                ...
                f"| Days to first payout 95% interval | {_fmt_days(float(block.get('mean_days_to_first_payout_trading_ci95_low', float('nan'))))} to {_fmt_days(float(block.get('mean_days_to_first_payout_trading_ci95_high', float('nan'))))} |",
                ...
                f"| Avg net 95% interval | {_fmt_money(float(block.get('avg_net_profit_per_trader_ci95_low', float('nan'))))} to {_fmt_money(float(block.get('avg_net_profit_per_trader_ci95_high', float('nan'))))} |",
                f"| Avg ROI | {_fmt_pct(float(block.get('avg_roi_pct', 0)))} |",
                f"| Avg ROI 95% interval | {_fmt_pct(float(block.get('avg_roi_pct_ci95_low', float('nan'))))} to {_fmt_pct(float(block.get('avg_roi_pct_ci95_high', float('nan'))))} |",
                f"| % positive ROI | {_fmt_pct(float(block.get('pct_positive_roi', 0)))} |",
                f"| % positive ROI 95% interval | {_fmt_pct(float(block.get('pct_positive_roi_ci95_low', float('nan'))))} to {_fmt_pct(float(block.get('pct_positive_roi_ci95_high', float('nan'))))} |",
